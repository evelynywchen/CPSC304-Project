<html>
<head>
    <title>Insert into Artificial Structures</title>
...
<h2>Insert Values into Artificial Structures</h2>
<form method="POST" action="AS.php"> <!--refresh page when submitted-->
    <input class="btn" type="hidden" id="insertQueryRequest" name="insertQueryRequest">
    Artificial Structure ID: <input class="btn" type="text" name="ID"> <br /><br />
...
<h2>
    ...
    function handleInsertRequest() {
        ...
        executeBoundSQL("insert into ArtificialStructures values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
        OCICommit($db_conn);
