<html>
<head>
    <title>Insert into Organization</title>
...
<h2>Insert Values into Organization</h2>
<form method="POST" action="org.php"> <!--refresh page when submitted-->
    <input class="btn" type="hidden" id="insertQueryRequest" name="insertQueryRequest">
    Organization ID: <input class="btn" type="text" name="ID"> <br /><br />
    Name: <input class="btn" type="text" name="name"> <br /><br />
    Funds: <input class="btn" type="text" name="funds"> <br /><br />
    Found: <input class="btn" type="text" name="found"> <br /><br />
    Size: <input class="btn" type="text" name="size"> <br /><br />
...
<h2>
    ...
    function handleInsertRequest() {
        ...
        executeBoundSQL("insert into Organization values (:bind1, :bind2, :bind3, :bind4, :bind5)", $alltuples);
        OCICommit($db_conn);
