<html>
<head>
    <title>Insert into Resources</title>
...
<h2>Insert Values into Resources</h2>
<form method="POST" action="res.php"> <!--refresh page when submitted-->
    <input class="btn" type="hidden" id="insertQueryRequest" name="insertQueryRequest">
    Resource ID: <input class="btn" type="text" name="ID"> <br /><br />
...
<h2>
    ...
    function handleInsertRequest() {
        ...
        executeBoundSQL("insert into Resources values (:bind1, :bind2, :bind3)", $alltuples);
        OCICommit($db_conn);
