...
<h2>Insert Values into Plants</h2>
<form method="POST" action="plants.php"> <!--refresh page when submitted-->
    <input class="btn" type="hidden" id="insertQueryRequest" name="insertQueryRequest">
    Plant ID: <input class="btn" type="text" name="pID"> <br /><br />
...
<h2>
    ...
    function handleInsertRequest() {
        ...
        executeBoundSQL("insert into Plants values (:bind1, :bind2)", $alltuples);
        OCICommit($db_conn);
